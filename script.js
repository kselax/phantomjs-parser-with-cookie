...
page.open(url,function(status){
    if(status==="success"){
        ...
        //     var e1 = document.querySelector('input[name="USER_LOGIN"]');
        //     e1.value=login;
        //     var e2=document.querySelector('input[name="USER_PASSWORD"]');
        //     e2.value=pass;
        //     var e3=document.querySelector('button[type="submit"]');
        //     e3.click();
        // },login,pass);
